...
@section('content')
    <a href="{{ route('admin.books.index') }}"
        class="d-inline-flex align-items-center gap-1 moco-note text-decoration-none mb-3" style="color:var(--moco-blue);">
            ...
            <div class="col-md-3">
                ...
                <div class="moco-upload-box" id="uploadBox" onclick="document.getElementById('coverInput').click()">
                    @if(isset($book) && $book->cover)
                        <img src="{{ asset('storage/' . $book->cover) }}" id="coverPreview"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="tahun_terbit"
                            value="{{ old('tahun_terbit', $book->tahun_terbit ?? date('Y')) }}"
