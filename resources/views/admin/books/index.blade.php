...
@section('content')
    ...
    <form method="GET" action="{{ route('admin.books.index') }}" class="d-flex gap-2 mb-3">
        <div class="input-group" style="max-width:320px;">
            ...
            <input type="text" name="search" value="{{ request('search') }}" class="form-control moco-input"
            ...
            <tbody>
                @forelse($books as $book)
                    <tr>
                        <td>
                            <div
                                style="width:80px;height:110px;border-radius:6px;background:var(--moco-muted-bg);overflow:hidden;">
                                @if($book->cover)
                                    <img src="{{ asset('storage/' . $book->cover) }}" class="rounded"
                        ...
                        <td>
                            <a href="{{ route('admin.books.edit', $book->id) }}" class="btn btn-sm btn-moco-outline me-1">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center moco-note py-4">Belum ada buku.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
